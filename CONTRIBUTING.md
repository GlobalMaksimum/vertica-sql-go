First off, thank you for considering contributing to _vertica-sql-go_ and helping make it even better than it is today!
...
If you find a bug, submit an [issue](https://github.com/GlobalMaksimum/vertica-sql-go/issues) with a complete and reproducible bug report. If the issue can't be reproduced, it will be closed. If you opened an issue, but figured out the answer later on your own, comment on the issue to let people know, then close the issue.
...
Feel free to share your ideas for how to improve _vertica-sql-go_. We’re always open to suggestions.
You can open an [issue](https://github.com/GlobalMaksimum/vertica-sql-go/issues)
...
Fork the project [on Github](https://github.com/GlobalMaksimum/vertica-sql-go) and check out your copy locally.
...
_vertica-sql-go_ comes with a driver test of its own, in the root directory of the code base. It’s our policy to make sure all tests pass at all times.
...
When you think your work is ready to be pulled into _vertica-sql-go_, you should create a pull request(PR) at GitHub.
